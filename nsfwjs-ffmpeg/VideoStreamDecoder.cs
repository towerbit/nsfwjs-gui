...
namespace FFmpeg.AutoGen.Example
{
    public sealed unsafe class VideoStreamDecoder : IDisposable
    {
        ...
        public AVCodecContext pCodecContext { get => *_pCodecContext; }
        ...
        public VideoStreamDecoder(string url, AVHWDeviceType HWDeviceType = AVHWDeviceType.AV_HWDEVICE_TYPE_NONE)
        {
            ...
            ffmpeg.avformat_open_input(&pFormatContext, url, null, &opts).ThrowExceptionIfError();
            ...
            FrameRate = pFormatContext->streams[_streamIndex]->avg_frame_rate.num / pFormatContext->streams[_streamIndex]->avg_frame_rate.den;
